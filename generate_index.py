#!/usr/bin/env python3
"""
Génère unified_index.json avec les VRAIS paths complets
Compatible avec la structure:
  Methodes/[Méthode]_with_index/assets/page_XXXX.jpg
"""
    ...
    for root, dirs, files in os.walk(base_path):
        ...
        for filename in files:
            ...
            if ext in ['jpg', 'jpeg', 'png']:
                # Extraire les métadonnées depuis le path
                ...
                resource = {
                    ...
                    "url": relative_path_str,  # ✅ PATH COMPLET DEPUIS LA RACINE
                    "metadata": {
                        "method": method_name,
                        "page": page_num,
                        "filename": filename
            ...
            # MP3
                ...
                # Extraire métadonnées depuis le path
                parts = relative_path_str.split('/')
                ...
                if 'Track' in filename or 'track' in filename.lower():
                    try:
                        # Gérer "Track 01.mp3" et "Track01.mp3"
                ...
                resource = {
                    ...
                    "url": relative_path_str,  # ✅ PATH COMPLET
                    "metadata": {
                        "method": method_name,
                        "track": track_num,
                        "filename": filename,
...
def generate_unified_index(output_file='unified_index.json'):
    """Génère l'index unifié"""
    print("🎸 Génération de l'index unifié...")
    ...
    # Sauvegarder
    print(f"💾 Sauvegarde de {len(resources)} ressources dans {output_file}...")
